...
export default function TournamentsPage() {
  ...
  // Inicializa o torneio ativo (destacado)
  useEffect(() => {
    const featured = mockTournaments.find(t => t.featured);
    if (featured) {
      setActiveTournament(featured);
    }
  }, []);
  ...
  const filteredTournaments = mockTournaments.filter(tournament => {
    ...
    const matchesFormat = formatFilter === 'todos' || tournament.format.toLowerCase() === formatFilter.toLowerCase();
