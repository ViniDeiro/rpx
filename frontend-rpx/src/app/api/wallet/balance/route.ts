...
export async function GET(req: NextRequest) {
  try {
    ...
    console.log(`💰 [SIMULAÇÃO] Saldo atual: R$${userWallets[userId].balance}`);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log(`💰 [SIMULAÇÃO] Operação: ${operation}, Valor: R$${amount}`);
    console.log(`💰 [SIMULAÇÃO] Saldo anterior: R$${oldBalance}, Novo saldo: R$${userWallets[userId].balance}`);
