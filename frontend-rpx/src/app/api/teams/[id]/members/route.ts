...
export async function POST(
  ...
  try {
    ...
    if (team.members.some((member: any) => member.userId === targetUserId)) {
      return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    const targetMemberIndex = team.members.findIndex((member: any) => member.userId === targetUserId);
    ...
    const actingMember = team.members.find((member: any) => member.userId === userId);
