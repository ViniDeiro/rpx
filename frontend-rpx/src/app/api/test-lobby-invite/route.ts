...
// GET: Testar conexão e estrutura de dados
...
// POST: Testar criação de lobby e envio de convite
export async function POST(request: Request) {
  try {
    ...
    const lobbyId = lobbyResult.insertedId.toString();
    ...
    return NextResponse.json({
      ...
      results: {
        lobby: {
          id: lobbyId,
          insertedId: lobbyResult.insertedId.toString()
        },
        invite: {
