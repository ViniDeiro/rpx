...
function DepositSuccessContent({ refreshUser }: { refreshUser: () => Promise<void> }) {
...
function DepositSuccessFallback() {
  return (
  ...
  return (
    <div className="container py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <Suspense fallback={<DepositSuccessFallback />}>
          <DepositSuccessContent refreshUser={refreshUser} />
        </Suspense>
      </div>
    </div>
  );
